     ...
     <form action='<?php echo e(url('mahasiswa/' . $data->nim)); ?>' method='post' enctype="multipart/form-data">
         ...
         <div class="my-3 p-3 bg-body rounded shadow-sm">
             ...
             <div class="mb-3 row">
                 ...
                 <div class="col-sm-10">
                     <input type="text" class="form-control" name='jenis_kelamin' value="<?php echo e($data->jenis_kelamin); ?>"
                         id="nama">
                 </div>
             </div>
             <div class="mb-3 row">
             ...
             <?php if($data->foto): ?>
                 <div class="mb-3">
                     <img style="max-height: 50px; max-width:50px col-sm-2" src="<?php echo e(url('foto') . '/' . $data->foto); ?>">
                 </div>
             <?php endif; ?>
             <div class="mb-3 row">
...
<?php echo $__env->make('layout.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\study-web\crud-larravel\resources\views/mahasiswa/edit.blade.php ENDPATH**/ ?>